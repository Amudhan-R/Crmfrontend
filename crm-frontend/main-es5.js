...
var API_URL = "https://cutomermanagement.herokuapp.com";
...
var CustomerFormComponent = /** @class */ (function () {
    function CustomerFormComponent(service, route, router) {
    ...
    CustomerFormComponent.prototype.ngOnInit = function () {
        ...
        if (this.id != -1)
            this.service.retrieveCustomer("houarizegai", this.id).subscribe(function (response) { return _this.customer = response; });
    };
    CustomerFormComponent.prototype.onSave = function () {
        var _this = this;
        if (this.id == -1) {
            // call create customer service
            this.service.addCustomer({ username: "houarizegai", customer: this.customer }).subscribe(function (response) {
            ...
            this.service.updateCustomer("houarizegai", this.customer).subscribe(function (response) {
                console.log(response);
                _this.router.navigate(['customers']);
            });
        }
    };
    CustomerFormComponent.ctorParameters = function () { return [
...
var Customer = /** @class */ (function () {
    function Customer(id, name, birthDate, email) {
        this.id = id;
        this.name = name;
...
var CustomersComponent = /** @class */ (function () {
    function CustomersComponent(service, router, toastr) {
        this.service = service;
        this.router = router;
        this.toastr = toastr;
    }
    ...
    CustomersComponent.prototype.retrieveAllCustomers = function () {
        var _this = this;
        this.service.retrieveAllCustomers("houarizegai").subscribe(function (response) {
            // console.log(response);
    ...
    CustomersComponent.prototype.updateCustomer = function (id) {
    ...
    CustomersComponent.prototype.deleteCustomer = function (id) {
        ...
        this.service.deleteCustomer("houarizegai", id).subscribe(function (response) {
            // console.log(response);
            _this.toastr.success('Success', 'The customer has been deleted!', {
                timeOut: 3000
            });
            _this.retrieveAllCustomers(); // refresh customers
        });
    };
...
var LoginComponent = /** @class */ (function () {
    ...
    function LoginComponent(router, hardcodedAuthenticationService, basicAuthenticationService, toastr) {
        this.router = router;
    ...
    LoginComponent.prototype.handleLogin = function (form) {
    ...
    LoginComponent.prototype.handleBasicAuthLogin = function (form) {
        var _this = this;
        this.basicAuthenticationService.executeAuthenticationService(this.username, this.password).subscribe(function (data) {
            ...
            _this.toastr.error('Error', _this.errorMessage, { timeOut: 3000 });
        });
    };
    LoginComponent.prototype.handleJWTAuthLogin = function (form) {
        var _this = this;
        this.basicAuthenticationService.executeJWTAuthenticationService(this.username, this.password).subscribe(function (data) {
            console.log(data);
            _this.invalidLogin = false;
            _this.router.navigate(['welcome', _this.username]);
        }, function (error) {
...
var LogoutComponent = /** @class */ (function () {
    function LogoutComponent(hardcodedAuthenticateService) {
...
var BasicAuthenticationService = /** @class */ (function () {
    ...
    BasicAuthenticationService.prototype.executeAuthenticationService = function (username, password) {
        ...
        return this.http.get(_app_constants__WEBPACK_IMPORTED_MODULE_4__["API_URL"] + "/basicauth", { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
            sessionStorage.setItem(AUTHENTICATED_USER, username);
    ...
    BasicAuthenticationService.ctorParameters = function () { return [
...
var AuthenticationBean = /** @class */ (function () {
    ...
    AuthenticationBean.ctorParameters = function () { return [
        { type: String }
    ]; };
...
var HttpIntercepterBasicAuthService = /** @class */ (function () {
    ...
    HttpIntercepterBasicAuthService.ctorParameters = function () { return [
...
var WelcomeComponent = /** @class */ (function () {
    ...
    WelcomeComponent.prototype.getWelcomeMessageWithPathVariable = function () {
        var _this = this;
        this.service.executeHelloWorldServiceWithPathVariable(this.name).subscribe(function (response) { return _this.handleSuccessfulResponse(response); });
    };
